...
export const plantJobs: PlantJob[] = [
  {
    ...
    time: "07:00",
    tz: "Europe/Berlin",
    nextRun: "2026-09-02T05:00:00+00:00",
    nextLabel: "Wed 2 Sep · 07:00 CET",
    kind: "live",
    channel: "Grok email + app",
    note: "One frontier call. This is the send when nobody has the tab open. Costs tokens once a day.",
