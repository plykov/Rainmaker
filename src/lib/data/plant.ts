...
export const plantJobs: PlantJob[] = [
  {
    ...
    time: "07:00",
    tz: "Europe/Berlin",
    nextRun: "2026-09-05T05:00:00+00:00",
    nextLabel: "Sat 5 Sep · 07:00 CET",
    kind: "live",
    channel: "Grok email + app + rainmaker.grok.me",
    note: "Writes ingest/daily/latest.json. grok.me reads it via same-origin /api/live — no republish.",
